...
(function() {
  ...
  module.exports = Context = (function() {
    ...
    Context.prototype.findVariable = function(key) {
      ...
      return Liquid.async.when(variable).when(function(variable) {
    ...
    Context.prototype.variable = function(markup) {
      ...
      return Liquid.async.promise(function(future) {
        ...
        if (parts.length === 0) {
          return future.drain(object);
        }
        mapper = function(part, next) {
          if (object === null) {
            return next();
          }
          return Liquid.async.when(object).done(function(_object) {
            var bracketMatch;
            ...
            return Liquid.async.when(part).done(function(part) {
              ...
              if (isArrayAccess || isObjectAccess) {
                return Liquid.async.when(_this.lookupAndEvaluate(object, part)).done(function(result) {
