...
Templates.Entity = [
  '<div class="row hoff2">',
    ...
    // '</ul>',
    '<div class="span52 entity-pane pane">',
      '<div class="" style="padding:0; padding-bottom: 20px;">',
        ...
        '<span class="tbl-wrapper span52 hoff1">',
          '<span class="tbl">',
            '<div class="column">',
...
'<div class="row hoff1">',
    // '<ul class="span6 hoff1 sub-menu">',
    //   '<li class="show-data show-data">',
    //     'Show User Data',
    //   '</li>     ' ,
    // '</ul>',
    '<div class="span52 entity-pane pane" id="user-entity">',
      '<div style="display:inline-block;">',
       ' <div class="hoff2 offset2 span32">',
          '<h2 class="">User</h2>',
        '</div>',
        '<span class="span13 right right hoff2 right-panel">',
          '<span class="span5 hi5 excel right-icon">',
            '<span class="icon"></span>',
          ...
          '<span class="tbl">',
            ...
            '<div class="column span6">',
             ...
             ' <div class="hi3">',
              ...
              '<div class="hi2"><input class="cb-login" type="checkbox" checked disabled></div>',
            '</div>',
           ' <ul class="property-list"></ul><a class="column span8 add-property-column">',
            '<form class="add-property-form" style="display:none">',
             ' <div class="hi2 hdr">',
                '<input type="text" class="property-name-input span7" placeholder="Property Name...">',
              '</div>',
            '</form>',
            '<span class="plus-icon"></span><span class="add-property-button">Add Property</span>',
          '</a>',
        '</span>',
      '</span>',
    '</div>',

    '<div class="span52 hi9" id="forms">',
     ' <hr style="display:block; width:100%;" class="hoff1">',
      '<h3 class="offset hoff2 offset2">Authentication</h3>',
      '<div class="hoff1 offset2 span52">',
