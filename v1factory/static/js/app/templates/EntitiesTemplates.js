...
'<div class="row hoff1">',
    ...
    '<div class="span58 hi17" id="forms">',
     ' <hr style="display:block; width:100%;" class="hoff1">',
      '<h3 class="offset hoff2 offset2">Forms</h3>',
      '<div class="hoff1 offset2 span10">',
        ...
        '<label class="hi2"><input class="cb-login" id="twitter" type="checkbox" value="twitter">Twitter Login</label>',
