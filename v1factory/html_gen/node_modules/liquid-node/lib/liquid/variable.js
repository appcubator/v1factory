    ...
    Variable.prototype.render = function(context) {
      ...
      mapper = function(output, filter) {
        ...
        waitingFor = _(dependencies).select(function(o) {
          return Liquid.async.isPromise(o);
        });
        execute = function() {
          try {
        ...
        if (waitingFor.length > 0) {
          ...
          return Liquid.async.promise(function(result) {
            ...
            return dependencies.forEach(function(k, i) {
              if (!Liquid.async.isPromise(k)) {
                return;
              }
              return k.always(function(err, r) {
                if (i === 0) {
                  output = r;
                } else {
                  filterargs[i - 1] = r;
      ...
      return Liquid.async.when(context.get(this.name)).when(function(value) {
        return Liquid.async.reduce(_this.filters, mapper, value).when(function(value) {
